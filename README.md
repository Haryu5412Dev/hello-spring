...
본 프로젝트는 Spring Boot 기반의 기본 회원 관리 예제를 과제 요구 사항에 맞게 확장하여 구현하였습니다.

기존 예제가 단순히 name만으로 회원을 등록하던 구조에서 벗어나, 실제 서비스에서 요구되는 loginId, password, phoneNumber 기반의 회원 관리 기능을 추가했으며, 사용자가 스스로 비밀번호를 변경할 수 있는 기능까지 포함하도록 개선했습니다.
